...
namespace SlugMod.Content.Items.Ammo
{
	public class GrenadeBullet : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<Projectiles.GrenadeBullet>(); // The projectile that weapons fire when using this item as ammunition.
